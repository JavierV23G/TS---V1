...
import '../../../../../../../styles/pt-ot-st/Patients/InfoPaciente/NotesAndSign/sections/SignatureSection.scss';
...
const SignatureSection = ({ 
  ...
  // Handle signature changes and update section data
  const handleSignatureChange = (signatureData) => {
    const updatedData = {
      ...data,
      signature: signatureData,
      signedAt: new Date().toISOString(),
      signedBy: config?.staffName || 'Unknown'
    };
...
// Original SignaturePad component (now internal)
const SignaturePad = ({ 
  label = 'SIGNATURE', 
  onSignatureChange, 
