...
const DevPatientsPage = ({ selectedCompany, onBackToCompanies }) => {
        ...
        <div className="header-container">
          <div className="logo-container">
            ...
            <div className="menu-navigation">
              ...
              {selectedCompany && onBackToCompanies && (
                <button 
          ...
          <div className="patients-header">
            <div className="patients-title-container">
              <h1 className="patients-title">
                ...
                {selectedCompany && <span className="company-suffix"> - {selectedCompany.companyName}</span>}
              </h1>
              <p className="patients-subtitle">
                {selectedCompany 
                  ? `Manage patients for ${selectedCompany.companyName} - ${selectedCompany.address.city}, ${selectedCompany.address.state}`
