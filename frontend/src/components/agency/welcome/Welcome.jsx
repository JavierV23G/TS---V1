...
import AgencyInfoWelcome from './infoWelcome';
      ...
      <main className="main-content">
        ...
        <div className="welcome-container welcome-container-top">
          ...
          <p className="welcome-subtitle">
            Agency Dashboard - Manage your patients and financial operations
            <span className="cursor-blink">_</span>
          </p>
        </div>
        
        {/* Info welcome component with responsive props */}
        <AgencyInfoWelcome isMobile={isMobile} isTablet={isTablet} />
      </main>
