...
const AgencyInfoWelcome = ({ isMobile, isTablet }) => {
  ...
  // Financial data for agency (higher volumes - 300+ patients)
  const [financialData, setFinancialData] = useState({
    totalRevenue: 245750, // Higher revenue for agency scale
    monthlyRevenue: 52450, // Monthly revenue reflecting 300+ patients
    pendingPayments: 15800, // Higher pending payments
    revenueGrowth: 24, // Strong growth for established agency
    completedSessions: 782 // More sessions reflecting agency scale
  });
  ...
  const handleViewAccountingDashboard = () => {
    const baseRole = currentUser?.role?.split(' - ')[0].toLowerCase() || 'agency';
        ...
        >
          ...
          <div className="card-content">
            ...
            <div className="card-description">
              <p>Resources and tutorials to optimize your agency operations</p>
            </div>
...
export default AgencyInfoWelcome;